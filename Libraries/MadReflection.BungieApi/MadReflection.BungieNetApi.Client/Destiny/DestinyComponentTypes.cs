namespace BungieNet.Destiny
{
    public static class DestinyComponentTypes
    {
        ...
        /// </summary>
        public static readonly DestinyComponentType[] All =
        {
        ...
        /// </summary>
        public static readonly DestinyComponentType[] Profile =
        {
            DestinyComponentType.Profiles,
            DestinyComponentType.VendorReceipts,
            DestinyComponentType.ProfileInventories,
        ...
        /// </summary>
        public static readonly DestinyComponentType[] Character =
        {
            DestinyComponentType.Characters,
            DestinyComponentType.CharacterInventories,
            DestinyComponentType.CharacterProgressions,
