...
namespace NFLBot.Models
{
    ...
    public partial class DummyReward
    {
    ...
    public partial class DestinyActivityDefinition
    {
        public static DestinyActivityDefinition FromJson(string json) => JsonConvert.DeserializeObject<DestinyActivityDefinition>(json, NFLBot.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this DestinyActivityDefinition self) => JsonConvert.SerializeObject(self, NFLBot.Models.Converter.Settings);
    }
